...
grep(html, r'<link[^>]*href="https://fonts\.g(?:oogle|static)', "external Google-Fonts hint (fonts are local)", hard)
grep(html, r'action="/\.wf_auth"', "dead Webflow auth endpoint (401 page)", hard)
grep(html, r"<%WF_FORM_VALUE_", "unrendered Webflow server token", hard)
