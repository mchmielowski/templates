...
## Where things live
- `the main CSS file` — the design: tokens (`:root`) + all component styles. Change colors/fonts/
...
- Pages (20): 401.html, 404.html, about.html, case-study/case-study-a.html, case-study/case-study-b.html, case-study/case-study-c.html, contact/contact-a.html, contact/contact-b.html, contact/contact-c.html, detail_journal.html, detail_work.html, homepage/home-b.html, homepage/home-c.html, index.html …
...
## Customize design via tokens (in `the main CSS file` `:root`)
```css
